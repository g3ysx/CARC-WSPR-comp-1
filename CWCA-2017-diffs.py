...
print
print 'Slots worked by GX3WSC not worked by G3YSX'
diff = sorted(list(filter_list(GX3WSC, G3YSX)))

bnd = '999'
slotString = ''
bndCnt = 0
for observer in diff:
   obsData = observer.split('m')
   if obsData[0] <> bnd:
      if bndCnt<>0:
         print slotString + '  (Total: ' + str(bndCnt) + ')'
...
print
print 'Slots worked by GX3WSC not worked by M0TZZ'
diff = sorted(list(filter_list(GX3WSC, M0TZZ)))
...
print
print 'Slots worked by G3YSX not worked by M0TZZ'
diff = sorted(list(filter_list(G3YSX, M0TZZ)))
